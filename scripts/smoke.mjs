...
// minimal DOM stubs for canvas-texture generation outside a browser
const noop = () => {};
const ctx2d = new Proxy({}, {
  get: (t, k) => (k === 'createImageData'
...
for (const create of [createNeonScene, createDunesScene, createTempleScene, createVoidScene]) {
  const sc = create();
  try {
